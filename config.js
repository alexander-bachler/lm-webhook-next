...
module.exports = {
  ...
  webhook: {
    ...
    webhookSiteToken: process.env.WEBHOOK_SITE_TOKEN || 'fbd2d5a5-d00d-4129-b533-edbc9f438088',
    webhookSiteApiKey: process.env.WEBHOOK_SITE_API_KEY || '52e69666-a1da-478f-b060-7b029a5f5634'
  },
